...
import { Card, Button, Radio, Image, Badge, Row, Col, Typography, Space } from 'antd';
            ...
            <Row gutter={[24, 24]}>
                ...
                <Col span={14}>
                    <Space direction='vertical'>
                        ...
                        <Title level={3} className="text-red-600">203.000 ₫</Title>
                        <Space>
                        ...
                        <Paragraph className="mt-4" type="secondary">
                            Giao Nhanh Miễn Phí 2H - Nhận hàng trước 16h hôm nay nếu đặt trong 43 phút tới.
                        </Paragraph>
                    </Space>
                </Col>
            </Row>
